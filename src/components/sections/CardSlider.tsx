...
export default function CardSlider() {
  ...
  return (
    <div className="w-full h-[100dvh] flex flex-col items-center justify-center bg-black text-white px-4 relative">
      <div className="text-center mb-6">
        <h1 className="text-4xl font-bold uppercase">¡Conoce nuestras actividades!</h1>
        <p className="text-lg text-gray-300 mt-2">Desliza y explora cada una</p>
      </div>
  ...
  {cards.map((card) => (
    <SwiperSlide key={card.id} className="flex justify-center items-center">
      <div
        ...
        className="relative w-[320px] h-[80vh] max-h-[700px] rounded-[2rem] overflow-hidden shadow-2xl cursor-pointer group transition-transform duration-300 hover:scale-[1.01]"
        style={{
...
{selectedCard && (
  <div className="fixed inset-0 z-[9999] bg-black/70 flex items-center justify-center px-4">
    <div className="bg-white text-black rounded-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto relative">
      ...
      {/* Sección 2: Texto con grilla de imágenes */}
